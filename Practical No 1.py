#S077 Ekta Buneti
#Q1Create and manipulate structures to model ADTs like Student, Book, or Employee.
...
def stack_operation():
    ...
    cprint("Welcome to the International Stack Operation Program!",
           "cyan", attrs=["bold"])
    ...
    while True:
        ...
        try:
            ...
            cprint("Invalid input. Please enter a number between 1 and 6.",
                   "red")
            continue
        ...
        if choice == 1:
            ...
            cprint("Invalid choice. Please select a number between 1 and 6.",
                   "red")


# Calling the function to start the stack operation
